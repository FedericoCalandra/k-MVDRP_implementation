...
class RTSSolverV2:
    ...
    def transform(self):
        return Graph(self.problem_instance, self.visit_order, modified_op_builder=True)
    ...
    def shortest_path(self):
        ...
        return RTSV2Solution(is_infeasible, total_time, active_edges, time.time() - self.start_time, self.tsp_obj_value)
